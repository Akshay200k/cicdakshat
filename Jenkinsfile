        ...
        stage('upload artifact') {
            steps {
                dir('/var/lib/jenkins/workspace/cicd/target') {
                   nexusArtifactUploader artifacts: [[artifactId: 'cicd-artifact-id', classifier: '', file: 'devops-integration.jar', type: 'jar']], credentialsId: 'nexus-cred', groupId: 'com.truelearning', nexusUrl: '3.110.86.227:8081', nexusVersion: 'nexus3', protocol: 'http', repository: 'cicd', version: '0.0.1-SNAPSHOT'
                }
            }
        }
